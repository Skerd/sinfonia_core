...
type InternalServerErrorProps = WithLanguageType;

function InternalServerError({ resolveLanguageKey }: InternalServerErrorProps) {
...
export default compose(
    withLanguage("src/modules/core/components/custom/pages/internalServerError.tsx"),
)(InternalServerError);
