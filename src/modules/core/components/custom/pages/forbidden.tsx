...
type ForbiddenProps = WithLanguageType;

function Forbidden({ resolveLanguageKey }: ForbiddenProps) {
...
export default compose(
    withLanguage("src/modules/core/components/custom/pages/forbidden.tsx"),
)(Forbidden);
