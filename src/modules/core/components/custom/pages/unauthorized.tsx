...
type UnauthorizedProps = WithLanguageType;

function Unauthorized({ resolveLanguageKey }: UnauthorizedProps) {
...
export default compose(
    withLanguage("src/modules/core/components/custom/pages/unauthorized.tsx"),
)(Unauthorized);
