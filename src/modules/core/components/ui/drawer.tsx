...
/** Context for popover/select components to portal into the drawer instead of body. Fixes scroll inside Vaul drawer. */
...
function DrawerContentInner({ children }: { children: React.ReactNode }) {
  const containerRef = React.useRef<HTMLDivElement>(null)
  return (
    <DrawerPortalContainerContext.Provider value={containerRef}>
      <div ref={containerRef} className="flex min-h-0 flex-1 flex-col overflow-hidden" data-vaul-no-drag>
