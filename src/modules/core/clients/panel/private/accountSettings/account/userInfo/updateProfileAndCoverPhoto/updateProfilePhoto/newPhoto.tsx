...
import {UpdateProfilePhotoFormResponseType} from "armonia/src/modules/core/api/user/private/data/updateProfilePhoto.form.response.type.ts";
import withDebug from "@coreModule/helpers/hocs/withDebug.tsx";
import {useAccess} from "@coreModule/helpers/hocs/withAccess.tsx";
import HiddenElement from "@coreModule/components/custom/hiddenElement.tsx";

type NewPhotoProps = WithLanguageType & WithAxiosType<UpdateProfilePhotoFormResponseType> & {
...
function NewPhoto({
    ...
    useImperativeHandle(innerRef, () => ({
        success: (responseData?: UpdateProfilePhotoFormResponseType) => {
            onSuccess?.(responseData?.photo);
...
export default compose(
    withLanguage("src/modules/core/clients/panel/private/accountSettings/account/userInfo/updateProfileAndCoverPhoto/updateProfilePhoto/newPhoto.tsx"),
    withAxios(
        {
