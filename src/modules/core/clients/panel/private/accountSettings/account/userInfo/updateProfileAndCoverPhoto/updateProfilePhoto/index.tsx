...
const HiddenProfilePhoto = () => {
    return (
        <div className={cn("hover:cursor-pointer flex items-center justify-center bg-muted-foreground border-4 border-background absolute bottom-[-25px] left-8 rounded-full")} style={{width: avatarSize, height: avatarSize}}>
                ...
                <Dialog open={open} onOpenChange={setOpen}>
                    ...
                    <DialogContent className="md:min-w-[600px]">
                        ...
                        <div className="flex items-center justify-center py-4 w-full">
                            <div className="rounded-full flex justify-center items-center bg-muted-foreground text-background border-4 border-background" style={{width: dialogAvatarSize, height: dialogAvatarSize}}>
                                {
                                    !currentPhotoUrl ?
                                    <User size="91px"/>
                                    :
