...
type ResumeCronJobDialogProps = WithLanguageType & WithAxiosType<CronJob, SingleForm> & {
    open: boolean;
    onClose: () => void;
    job: CronJob;
...
export default compose(
    withLanguage("src/modules/core/clients/panel/private/tenancy/systemSettings/cronJobs/center/dialogs/resumeCronJobDialog.tsx"),
    withAxios<CronJob, SingleForm>(
        {
            method: "post",
            url: "/api/auxiliary/cron-jobs/resume",
            data: {},
        },
        true,
    ),
