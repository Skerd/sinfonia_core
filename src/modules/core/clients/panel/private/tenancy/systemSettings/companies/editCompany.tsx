...
const EditCompanyForm = createGenericEditPage<Company, EditCompanyFormData>({
    ...
    buildInitialValues: (companyData, writeFields): EditCompanyFormData => ({
        ...
        linkedin:       writeFields.linkedin       ? companyData.linkedin       : undefined,
        instagram:      writeFields.instagram      ? companyData.instagram      : undefined,
        facebook:       writeFields.facebook       ? companyData.facebook       : undefined,
