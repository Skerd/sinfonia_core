...
type RunCronJobDialogProps = WithLanguageType & WithAxiosType<CronJob, SingleForm> & {
    open: boolean;
    onClose: () => void;
    job: CronJob;
...
export default compose(
    withLanguage("src/modules/core/clients/panel/private/tenancy/systemSettings/cronJobs/center/dialogs/runCronJobDialog.tsx"),
    withAxios(
        {
            method: "post",
            url: "/api/auxiliary/cron-jobs/run",
            data: {},
        },
        true,
    ),
